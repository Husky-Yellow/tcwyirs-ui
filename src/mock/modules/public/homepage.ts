...
const APPLICATION_SCENARIOS: ApplicationScenario[] = [
  ...
  },
  {
    id: '02',
    title: '项目管理便捷',
    description: '集中化管理项目资源、流程与协作，透明可追踪，降低沟通成本。'
  },
  {
    id: '03',
    title: '企业流程管理',
    description: '规范企业内部流程，沉淀最佳实践，助力数字化治理。'
  },
  {
    id: '04',
    title: '资源溯源',
    description: '支持资源来源、版本、使用的全链路追溯，提升可信度。'
  }
]
