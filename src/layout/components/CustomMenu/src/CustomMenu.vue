        ...
        .map((route) => {
          ...
          if (
            ...
            return (
              ...
              >
                {level >= 2 && (onlyOneChild.meta?.icon || icon) && (
                  <Icon icon={onlyOneChild.meta?.icon || icon} class="menu-icon"></Icon>
                )}
          ...
          if (hasChildren) {
            return (
              <div key={fullPath} class="menu-group">
                ...
                {(level === 1 || isExpanded) && (
                  <div class="menu-children">{renderMenuItems(children, level + 1, fullPath)}</div>
                )}
              </div>
            )
          } else {
