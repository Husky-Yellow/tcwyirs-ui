...
export const getSmsTemplatePage = (params: PageParam) => {
  return request.get({ url: '/mq/sms-template/page', params })
}

// 查询短信模板详情
export const getSmsTemplate = (id: number) => {
  return request.get({ url: '/mq/sms-template/get?id=' + id })
}

// 新增短信模板
export const createSmsTemplate = (data: SmsTemplateVO) => {
  return request.post({ url: '/mq/sms-template/create', data })
}

// 修改短信模板
export const updateSmsTemplate = (data: SmsTemplateVO) => {
  return request.put({ url: '/mq/sms-template/update', data })
}

// 删除短信模板
export const deleteSmsTemplate = (id: number) => {
  return request.delete({ url: '/mq/sms-template/delete?id=' + id })
}
...
export const sendSms = (data: SendSmsReqVO) => {
  return request.post({ url: '/mq/sms-template/send-sms', data })
}
