...
import { ElTooltip, ElDropdown, ElDropdownMenu, ElDropdownItem, ElAvatar, ElIcon } from 'element-plus'
      ...
      <>
        {!props.isLoggedIn ? (
          <ElTooltip content="点击登录" placement="bottom">
            ...
            >
              <ElAvatar size={32} src={props.userAvatar} class="transition-transform duration-200 hover:scale-105" />
