<template>
  <div class="min-h-screen relative bg-cover bg-center bg-no-repeat" style="background-image: url('@/assets/imgs/bg/login/login_bg.png')">
    <!-- 左侧插图区域 -->
    ...
    <Transition appear enter-active-class="animate__fadeInRight">
      <div
        class="absolute right-[3.61%] top-1/2 -translate-y-1/2 w-full max-w-[480px]
               bg-white/95 rounded-24px p-48px
               shadow-[0_20px_80px_rgba(100,150,255,0.15),0_0_0_1px_rgba(255,255,255,0.5)]
               backdrop-blur-10px
               sm:right-[5%] sm:max-w-[400px] sm:p-32px
               md:right-[3.61%] md:max-w-[450px] md:p-40px
               lg:right-[3.61%] lg:max-w-[480px] lg:p-48px
               xl:right-[3.61%] xl:max-w-[480px] xl:p-48px
               max-sm:right-[4%] max-sm:left-[4%] max-sm:max-w-none max-sm:p-24px"
      >
